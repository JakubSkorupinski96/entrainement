            ...
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    <div class="label label-default pull-right">
                        id:<c:out value="${id}">v</c:out>
                    </div>
                    <h1>Edit Computer <c:out value="${name}"></c:out></h1>
                    ...
                    <form action="EditComputer" method="POST">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <option selected="selected"><c:out value="${companyId}">${companyName}</c:out></option>
                                    <c:forEach items="${companies}" var="company" >
                                    	<c:if test= "${company.name != companyName}">
